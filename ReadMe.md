...
useRouteMatch is used instead of using <Route>

2. How would you explain form validation to someone who has never programmed before?

Checking to make sure that all the information is filled in to be able to submit complete information

3. In 1-2 sentences, define end to end testing.

Testing the website ability to allow the user to complete the navigation process
